...
select
    ...
    -- identifiers
    PAYLOAD:id::NUMBER                                  as pr_id,
    PAYLOAD:number::NUMBER                              as pr_number,
    ...
    PAYLOAD:pull_request:merged_at::TIMESTAMP_TZ        as merged_at,

    -- is merged?
    (PAYLOAD:pull_request:merged_at IS NOT NULL)        as is_merged
